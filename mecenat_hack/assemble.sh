...
rm -f mecenat.smali.apk

echo 'Updating zip'
zip -ur se.mecenat.apk se.mecenat.app-1/assets/
echo 'Updated zip'

~/Android/sdk/build-tools/23.0.3/zipalign 4 mecenat.apk mecenat.smali.apk
~/Android/sdk/platform-tools/adb install -r mecenat.smali.apk
